...
10. **释义边界化**：中文一词多义会造成拼写歧义，释义要拆开各归一词（sera=傍晚；晚上 / notte=夜里，"晚上"只归前者）。用户提出释义质疑时先查库对账再动手。qualità=品质；质量（2026-09-18：裸写"质量"与物理"质量/重量"歧义，用户现场混淆过；重量=peso、物理质量=massa，均不在词库，"品质/质量"二字全库仅 qualità 占用）。
